...
import { ArrowUpIcon, Coffee, HeartHandshake, IdCard } from "lucide-react";
...
const memberships = [
  ...
  },
  {
    ...
    color: { bg: "bg-[#dcb273]", text: "text-[#85541d]" },
    price: "Rp. 250.000",
  },
];
  ...
  return (
    <div className="w-full min-h-screen flex flex-col gap-0 pt-0 pb-0 px-0">
      ...
      <main className="flex flex-col gap-16 relative">
        ...
        <section
          id="menu"
          className="flex flex-col gap-6 px-4 sm:px-8 md:px-12 lg:px-32 py-8 scroll-mt-24"
        >
      ...
      <footer
        id="contact"
        className="w-full flex flex-col gap-10 px-4 sm:px-8 md:px-16 lg:px-32 pt-12 pb-6 bg-white scroll-mt-24"
      >
